    ...
    <>
      ...
      <div className="prod-page">
        ...
        <div style={{
          ...
          <p style={{ color:"rgba(0,168,232,0.9)",fontSize:"0.88rem",fontFamily:"'Plus Jakarta Sans',sans-serif",fontWeight:600,margin:0,letterSpacing:"0.5px",textAlign:"center",zIndex:1 }}>🛍️ Exclusive RO Products &amp; Deals · Genuine Spare Parts · Doorstep Delivery</p>
